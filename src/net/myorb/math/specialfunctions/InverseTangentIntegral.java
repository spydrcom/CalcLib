...
public class InverseTangentIntegral 
{
	...
	public Double Ti2 (Double x)
	{
		...
		return atanSpline.evalIntegralOver (0, x);					// inverse identity leaves domain of spline at 0..1
	}
	...
	{
		if (x == 0.0) return 0.0;
		else if (x < 0.0) return - chi2 (-x);						// odd function
	...
	public static void main (String[] a)
	{
		...
		System.out.println ();
		System.out.println ("chi2(1)");
		System.out.println (approx = ITI.chi2 (1.0));

		double PI = Math.PI;
		error = PI*PI/8 - approx;
	...
	static final String ATANC_SPLINE =
			...
			+ "      { "
	        + "         \"lo\": 0.0,  \"hi\": 2.0, "
	        + "         \"delta\": 0.03333333333333333, \"error\": 1.0345015484606913E-17, "
	        + "         \"slope\": 0.6666666666666666,  \"unit\":  1.5, "

			+ "         \"coefficients\": " 
			+ "         [" 
			+ "            [ "
            + "                0.7897277926618893,     -0.1779797241259927,      0.0031601225804555435,   0.00434005556395784,   -0.0011611443226258924, "
            + "                1.3543004753285693E-4,   1.027695858125536E-5,   -8.41130645770704E-6,     1.8766241106150168E-6, -1.5279196933288337E-7, "
            + "               -4.1593787864479665E-8,   1.890100066075328E-8,   -3.49513821841335E-9,     1.1842643507086042E-10, 1.325477190279561E-10, "
            + "               -4.449587294500058E-11,   6.628545265655761E-12,   2.246898533006717E-13,  -3.934309455309484E-13,  1.0561837034136522E-13, "
            + "               -1.19125785642147E-14,   -1.7755017460028048E-15,  1.1393999325256373E-15, -2.440308180422557E-16,  4.986793085065418E-17, "
            + "                7.378344528959405E-18,  -1.75472614303237E-17,    4.938057995513696E-19,   2.183826622723069E-18, -2.510105279215813E-20, "
            + "               -1.0772583449505706E-19 "
			...
			/*
			 * original spline version (50% higher error number)
			 */
...
//			+ "      } " 
	...
	static final String ARTANHC_SPLINE =
			...
			+ "         \"slope\": 0.083333333333333333,  \"unit\":  12, "
			...
			+ "      { " 
			+ "         \"lo\": 0.75, \"hi\": 0.80, "
            + "         \"delta\": 8.333333333333333E-4, \"error\": 3.0045962731103313E-18, "
            + "         \"slope\": 0.01666666666666666,  \"unit\":  60, "

			+ "         \"coefficients\":  " 
			+ "         [ " 
			+ "            [ " 
			+ "                1.3331530411401333,      0.025237019350941515,    6.01677705013671E-4,     1.5512114825899663E-5,  4.4324191166493594E-7, "
            + "                1.33390662569882E-8,     4.1611204589019304E-10,  1.3313293372404504E-11,  4.342036381517888E-13,  1.411772480761241E-14, "
            + "                8.141025762984515E-16,  -3.419649709262559E-16,   3.9252814830580547E-16, -2.781818154073864E-16,  2.0631869162907215E-16, "
            + "                -8.904340800211847E-17,  8.040215077627132E-17,   8.244303322353375E-17,  -1.1851888818464082E-16, 9.807154046578766E-17, "
            + "                -6.324957343720295E-17,  4.6169321750970674E-18, -1.697686420592782E-18,  -4.538371334928337E-17,  3.625463476851537E-17, "
            + "                1.7206887600782265E-17, -1.4230666031398208E-17, -2.4496309536546167E-18,  2.0617346716117072E-18, 1.2289494461231407E-19, "
            + "                -1.045540297768081E-19 "
			+ "            ] "
			+ "         ] " 
			+ "      }, " 
			...
			+ "      { " 
	        + "         \"lo\": 0.8, \"hi\": 0.95, "
	        + "         \"delta\": 0.0025,  \"error\": 8.254118750806447E-18, "
	        + "         \"slope\": 0.0500,  \"unit\":  20, "

			+ "         \"coefficients\":  " 
			+ "         [ " 
			+ "            [ " 
            + "               1.567044851925667,      0.16365120980120948,     0.02003223586462829,     0.0028789668295801964,   4.576873022388326E-4, "
            + "               7.706170979460386E-5,   1.3473557771460447E-5,   2.419005317946303E-6,    4.42912976066071E-7,     8.233151406740803E-8, "
            + "               1.548901863046491E-8,   2.9424945410704687E-9,   5.635280776915391E-10,   1.0865984848669547E-10,  2.107376669940555E-11, "
            + "               4.1075959834193885E-12, 8.041253338574721E-13,   1.580806809256835E-13,   3.12385256343819E-14,    6.260557837998245E-15, "
            + "               1.2379188298715218E-15, 2.342423452668995E-16,   7.790308501368308E-17,  -1.8923274769707673E-17, -3.341804309465502E-17, "
            + "               1.190937401565842E-17,  1.1747762966950865E-17, -1.6523784729558299E-18, -1.5835075542965778E-18,  8.529563602425608E-20, "
            + "               7.81076193215552E-20 "
			+ "            ] "
			+ "         ] " 
			+ "      }, " 
			...
			+ "      { " 
	        + "         \"lo\": 0.95,  \"hi\": 1.0, "
	        + "         \"delta\": 8.33333333333334E-4, \"error\": 0.0, "
	        + "         \"slope\": 0.01666666666666668, \"unit\":  60, "

			+ "         \"coefficients\":  " 
			+ "         [ " 
			+ "            [ " 
			+ "                 2.3075305271366346,     0.35603018164422634,    0.07160986523227719,    0.018394742283930912,  0.00528676416654075, "
            + "                 0.0016180336324346707,  5.155525117200887E-4,   1.6896574165940737E-4,  5.658579862290838E-5,  1.944690343271358E-5, "
            + "                 6.808352592075893E-6,   2.663702703919115E-6,   1.0349172707833719E-6,  6.085211068274999E-7,  2.6123011873142843E-7, "
            + "                 1.9310428894458514E-7,  6.069541350837969E-8,  -8.980894969116093E-9,  -2.838015497242949E-8, -7.599640284347484E-8, "
            + "                -3.707790210446385E-8,  -3.52836634365982E-8,   -7.967386883827997E-9,   1.1369527591014612E-8, 6.7790225082595394E-9, "
            + "                 8.98127558751774E-9,    1.9008679956964825E-9, -3.27497949214998E-9,   -9.967922031825808E-10, 2.8263366783389294E-10, "
            + "                 9.414705954526643E-11 "
			+ "            ] "
			+ "         ] " 
			+ "      } " 
